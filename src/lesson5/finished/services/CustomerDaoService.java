package lesson5.finished.services;

import lesson5.finished.models.Customer;
...
public class CustomerDaoService {
  ...
  public static void createTable() {
    try (
      ...
      statement.executeQuery("CREATE TABLE CUSTOMERS (CUST_ID INTEGER PRIMARY KEY, CUST_F_NAME TEXT NOT NULL, CUST_L_NAME TEXT NOT NULL, CUST_EMAIL TEXT NOT NULL, CUST_CELL_NUM NOT NULL);");
